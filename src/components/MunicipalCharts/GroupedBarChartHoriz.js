...
export default class GroupedBarChartHoriz extends MunicipalChart {
  ...
  updateProvider() {
    ...
    setTimeout(() => {
      ...
      const margin = { top: 0, right: 0, bottom: 0, left: containerWidth <= 400 ? 0 : 200 };
      ...
      groups.selectAll(".year")
        ...
        .attr("class", "year")
        .attr("data-year", d => d.year)
        .attr("x", d => containerWidth <= 400 ? x(0) + 6 : x(0) - 50)
      ...
      groups.selectAll("rect.bar, rect.background, text.label, text.value")
        .on("mouseover", (e, d) => {
          ...
          d3.selectAll('text.year[data-year="' + d.year + '"]').attr("fill", containerWidth <= 400 ? "#ffffff" : "#333333");
